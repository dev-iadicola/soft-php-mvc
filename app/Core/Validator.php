...
class Validator
{
    ...
    public static function validate(array $inputsAndRusels, array $RulesAndmessages): self
    {
        $errors = [];
    ...
    protected static function checkRule(mixed $input, string $rule): bool
    {
        switch ($rule) {
            case 'email':
    ...
    public static function validatePDF(array $input): bool
    {
        $format = array('.pdf');
    ...
    public static function confirmedPassword(array $data): bool
    {
